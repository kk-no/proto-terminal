...
type RatingFluctuation struct {
	...
	Loser  uint32 `protobuf:"varint,2,opt,name=loser,proto3" json:"loser,omitempty"`
}
...
func (x *RatingFluctuation) GetWinner() uint32 {
	if x != nil {
		return x.Winner
	}
	return 0
...
func (x *RatingFluctuation) GetLoser() uint32 {
	if x != nil {
		return x.Loser
	}
	return 0
...
var file_vs_v1_vs_proto_rawDesc = []byte{
	...
	0x12, 0x14, 0x0a, 0x05, 0x6c, 0x6f, 0x73, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52,
