...
var file_sample_v1_sample_proto_rawDesc = []byte{
	...
	,
}
...
var file_sample_v1_sample_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_sample_v1_sample_proto_goTypes = []interface{}{
	(*PingRequest)(nil),  // 0: sample.v1.PingRequest
	(*PingResponse)(nil), // 1: sample.v1.PingResponse
}
var file_sample_v1_sample_proto_depIdxs = []int32{
	0, // 0: sample.v1.SampleService.Ping:input_type -> sample.v1.PingRequest
	1, // 1: sample.v1.SampleService.Ping:output_type -> sample.v1.PingResponse
...
func (c *sampleServiceClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sample.v1.SampleService/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SampleService_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sample.v1.SampleService/Ping",
	}
